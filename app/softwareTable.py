...
COLUMN_ORDER = [
    'Software', 'RP Name', 'Software Description', 'AI Description', 'Core Features', 
    'Software Documentation', 'Software Type', 'Research Area', 'Research Discipline',  
    'General Tags', "Software's Web Page", 
    'Research Field', 'Example Software Use', 'RP Software Documentation', 
    'Version Info', 'Software Class', 'Example Use'
    ]
# 2 <-> 7 , 3 <-> 15 , 4 <-> 11 , 5 <-> 8 , 7 <-> 6 
...
#       Return:                                                             #
#           df {pandas.DataFrame}: DataFrame of completed combined Table    #
#############################################################################
...
#       Return:                                                             #
#           df {pandas.DataFrame}: DataFrame of completed curated Table     #
#############################################################################
...
#       Functions                                                           #
#           json_sanitizer: Ensures JSON files are in a consistent format   # 
#                           that eases processing                           #
#       Parameters:                                                         #
#           override {boolean}: flag to force run JSON Sanitizer            #
#       Return:                                                             #
#           df {pandas.DataFrame}: DataFrame of completed generated table   #                                                    #
#############################################################################
